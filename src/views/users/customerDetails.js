...
const CustomerDetails = () => {
    ...
    const { is_sub_customer, name, first_name, middle_name, last_name, suffix, company_name, display_name, gst_registration_type
        , gstin_no, email, number, mobile_no, fax, other, website, Shipping_Address_copy, notes, preferred_payment_method, preferred_delivery_method, term, oppning_balance, as_of_date } = formData
                                ...
                                <div class="col-md-12 mb-4 pt-15">
                                    ...
                                    >
                                        ...
                                        <Tab eventKey="customer-details" title="Customers Details">
                                            ...
                                            <form >
                                                {/* <a className="edit-btn1" href="#">Edit</a> */}
                                                <a className="edit-btn1" name='option-1' onClick={e => onInputChangeD(e)}>Edit</a>
                                                <div class="row form-row">

                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Customer </label>
                                                        <input type="text" name="name" class="form-control" placeholder="Ajit" value={first_name}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Billing Address</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={b_street}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>email</label>
                                                        <input type="text" name="" class="form-control" placeholder="abc@gmail.com" value={email}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Spipping Address</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={s_street}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Phone</label>
                                                        <input type="text" name="number" class="form-control" placeholder="" value={mobile_no}
                                                        />
                                                    </div>
                                                    {/* <div class="form-group col-sm-6 custom-detail-input">
      <label>Terms</label>
      <input type="text" name="number" class="form-control" placeholder="" value={customer.email}
         />
    </div> */}
                                                    {/* <div class="form-group col-sm-6 custom-detail-input">
      <label>Mobile</label>
      <input type="text" name="" class="form-control" placeholder="" value={customer.email}
         />
    </div> */}
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Payment Method</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={preferred_payment_method
                                                        }
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Fax</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={fax}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Preferred Delivery Method</label>
                                                        <input type="text" name="" class="form-control" placeholder="None" value={preferred_delivery_method}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Other</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={other}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Tax Reg No.</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={tax_rego_no}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Website</label>
                                                        <input type="text" name="" class="form-control" placeholder="" value={website}
                                                        />
                                                    </div>
                                                    <div class="form-group col-sm-6 custom-detail-input">
                                                        <label>Tax Identifier No.</label>
